...
{
    public class WhenValidatingChapsPaymentForAccountWithChapsPaymentScheme: Specification
    {
        private readonly ChapsPaymentRule chapsPaymentRule;
        private readonly MakePaymentRequest makePaymentRequest;
        private bool result;
        private Account account ;
        public WhenValidatingChapsPaymentForAccountWithChapsPaymentScheme()
        {
