...
{
    public class WhenAValidPaymentRequestedForAAccount:Specification
    {
        ...
        public WhenAValidPaymentRequestedForAAccount()
        {
        ...
        public void Result()
        {
            makePaymentResult.Success.ShouldBeTrue("A Valid Payment Requested For a Account");
        }
